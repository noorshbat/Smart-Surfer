...
class AppInfoViewController: UIViewController {
    ...
    private let mdsVersionLabel: UILabel
    ...
    init() {
        ...
        self.appVersionLabel = UILabel.init(with: UIFont.systemFont(ofSize: 16, weight: .light),
                                            inColor: UIColor.titleTextBlack, lines: 1)
        self.mdsVersionLabel = UILabel.init(with: UIFont.systemFont(ofSize: 16, weight: .light),
                                            inColor: UIColor.titleTextBlack, lines: 1)
    ...
    override func viewDidLoad() {
        ...
        mdsVersionLabel.text = NSLocalizedString("APP_INFO_MDS_VERSION", comment: "") + "\( Movesense.api.mdsVersion() ?? "n/a")"
    ...
    private func layoutView() {
        ...
        view.addSubview(mdsVersionLabel)
        ...
        mdsVersionLabel.translatesAutoresizingMaskIntoConstraints = false
        ...
        NSLayoutConstraint.activate(
            [mdsVersionLabel .leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16.0),
             mdsVersionLabel.topAnchor.constraint(equalTo: appVersionLabel.bottomAnchor),
             mdsVersionLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16.0)])

        NSLayoutConstraint.activate(
            [appUpdatedLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16.0),
             appUpdatedLabel.topAnchor.constraint(equalTo: mdsVersionLabel.bottomAnchor),
