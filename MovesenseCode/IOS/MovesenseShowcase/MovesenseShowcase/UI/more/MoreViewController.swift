...
class MoreViewController: UIViewController {
    ...
    // Notice the substraction of 16 pixels which eaquals to the padding of UILabel
    func updateHeaderViewHeight(for header: UIView?) {
        guard let header = header else { return }
        header.frame.size.height = header.systemLayoutSizeFitting(CGSize(width: view.bounds.width - 16.0, height: 0)).height
    }
