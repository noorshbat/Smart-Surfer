//
// DashboardOperationViewControllerMagn.swift
// MovesenseShowcase
//
...
class DashboardOperationViewControllerMagn: UIViewController {

    private let viewModel: DashboardContainerViewModel

    private let secondsToPlot: Int = 5
    private let scaleView: DashboardPlotterScaleView = DashboardPlotterScaleView(scaleStep: 100, scaleRange: -5000...5000)
    ...
    @objc private func displayLinkTick() {
        guard let displayLink = displayLink,
            ...
            NSLog("DashboardOperationViewControllerMagn::scrollTick frame duration error.")
            return
        }
    ...
    private func plotDimensions(_ dimensions: [(CGFloat, UIColor)], step: CGFloat, scale: CGFloat) {
        guard let currentSlice = currentSlice,
            ...
            NSLog("DashboardOperationViewControllerMagn::plotVector integrity error.")
            return
        }
...
extension DashboardOperationViewControllerMagn: SelectorSliderDelegate {
...
extension DashboardOperationViewControllerMagn: Observer {
