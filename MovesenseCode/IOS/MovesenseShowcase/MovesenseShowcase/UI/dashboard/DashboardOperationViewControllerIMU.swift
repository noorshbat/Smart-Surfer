//
//  DashboardOperationViewControllerIMU.swift
//  MovesenseShowcase
//
...
class DashboardOperationViewControllerIMU: UIViewController {
    ...
    @objc private func displayLinkTick() {
        guard let displayLink = displayLink,
            ...
            NSLog("DashboardOperationViewControllerIMU::scrollTick frame duration error.")
            return
        }
    ...
    private func plotDimensions(_ dimensions: [(CGFloat, UIColor)], step: CGFloat, scale: CGFloat) {
        guard let currentSlice = currentSlice,
            ...
            NSLog("DashboardOperationViewControllerIMU::plotVector integrity error.")
            return
        }
...
extension DashboardOperationViewControllerIMU: SelectorSliderDelegate {
...
extension DashboardOperationViewControllerIMU: Observer {
